...
help:
	...
	@echo ""
	@echo "  Przerwa techniczna (ostrzezenie dla uzytkownikow):"
	@echo "    run-with-warning         - Deploy z uprzedzeniem: pull -> baner N min -> run -> odblokowanie"
	@echo "                               Parametry: MINUTES=5 SERVICE=10 MESSAGE='...' SITE_IDS='1 2'"
	@echo "    enable-site-down-warning - Sam baner (bez deployu)"
	@echo "    disable-site-down-warning - Zdejmij baner/blokade (odblokuj strone)"
	@echo "    extend-site-down-warning - Przesun deklarowany powrot: MINUTES=+10 albo MINUTES=-5"
	@echo "    status-site-down-warning - Stan przerwy (JSON=1 dla danych maszynowych)"
	@echo ""
	...
	@echo "    git-bez-klucza         - origin po HTTPS: git fetch bez agenta/klucza SSH (push nadal SSH)"
	@echo "    git-na-klucz           - origin z powrotem po SSH (pobieranie i push)"
	@echo "    test-git-remote        - Unit-testy scripts/git-remote.sh"
	@echo ""
	@echo "  Database:"
